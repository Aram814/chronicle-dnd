          ...
          {diceTypes.map((d) => {
            ...
            return (
              <button
                key={d}
                onClick={() => roll(sides)}
                className="flex flex-col items-center justify-center py-2 bg-stone-900/60 border border-amber-900/40 rounded-lg hover:bg-amber-900/30 hover:border-amber-700/60 transition-all group"
              >
