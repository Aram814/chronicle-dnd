        ...
        {stories.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {stories.map((s) => (
              <div
                key={s.id}
                className="bg-gradient-to-br from-stone-900/80 to-stone-950/80 border border-amber-900/30 rounded-xl p-5"
              >
                ...
                {s.current_situation && (
                  <p className="text-sm text-stone-500 italic mb-3">"{s.current_situation}"</p>
                )}
                <Link
